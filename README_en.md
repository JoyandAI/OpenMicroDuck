...
This is a prototype we assembled with Feetech HL-2909 servos and 3D-printed parts, to verify structural compatibility and the servo protocol.

The Zero adapter HAT has been ordered for fabrication and assembly; we will test it when the boards come back. In the meantime we will first verify servo control and the communication protocol.
